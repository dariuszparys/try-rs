...
### Changed
- Configured package metadata for crates.io publishing
...
[Unreleased]: https://github.com/dariuszparys/try-rs/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/dariuszparys/try-rs/compare/v0.1.0...v0.1.1
